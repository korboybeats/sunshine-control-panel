...
export const AI_PROVIDERS = [
  ...
  { label: 'Qwen (Tongyi Qianwen)', value: 'qwen', base: 'https://dashscope.aliyuncs.com/compatible-mode/v1', models: ['qwen-max', 'qwen-plus', 'qwen-turbo'], apiType: 'openai' },
  { label: 'Zhipu (GLM)', value: 'glm', base: 'https://open.bigmodel.cn/api/paas/v4', models: ['glm-4-plus', 'glm-4', 'glm-4-flash'], apiType: 'openai' },
  ...
  { label: 'Ollama (Local)', value: 'ollama', base: 'http://localhost:11434/v1', models: ['llama3', 'qwen2', 'mistral'], apiType: 'openai' },
  { label: 'OpenAI-Compatible', value: 'compatible', base: '', models: [], apiType: 'openai' },
]
