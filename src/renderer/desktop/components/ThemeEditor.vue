      ...
      <div v-if="open" class="theme-editor" @click.stop>
        ...
        <div class="editor-body">
          ...
          <section class="editor-section">
            <label class="section-title">Wallpaper</label>
            <div
            ...
            >
              <template v-if="wallpaper">
                ...
                <div class="wallpaper-actions">
                  <button class="wp-btn" @click.stop="triggerFileInput"><Refresh /> Replace</button>
                  <button class="wp-btn danger" @click.stop="$emit('removeWallpaper')">✕ Remove</button>
                </div>
              </template>
              <template v-else>
                <div class="drop-icon"><Picture /></div>
                <div class="drop-text">Drag an image here<br/><small>or click to choose a file</small></div>
              </template>
            </div>
            <input
              ref="fileInputRef"
          ...
          <section class="editor-section">
            ...
            <div class="control-row">
              <span class="control-label">Secondary Accent</span>
            ...
            <div class="control-row">
              <span class="control-label">Background Primary</span>
            ...
            <div class="control-row">
              <span class="control-label">Background Secondary</span>
          ...
          <section class="editor-section">
            ...
            <div class="control-row">
              <span class="control-label">Card Radius</span>
          ...
          <section class="editor-section">
            ...
            <div class="control-row">
              <span class="control-label">Background Grid</span>
              <label class="switch">
          ...
          <!-- 导入导出 -->
          <section class="editor-section">
            <label class="section-title">Data</label>
            <div class="action-row">
              <button class="action-btn" @click="handleExport"><Upload /> Export Theme</button>
              <button class="action-btn" @click="handleImport"><Download /> Import Theme</button>
            </div>
          </section>
        </div>
      </div>
